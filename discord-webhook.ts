...
async function run() {
	...
	// vitest repo is not cloned when release
	...
	const webhookContent = {
		username: `vitest-ecosystem-ci (${env.WORKFLOW_NAME})`,
		avatar_url: 'https://github.com/vitest-dev.png',
		embeds: [
			{
...
function createTargetText(
	...
	const repoText = repo !== 'vitest-dev/vitest' ? `${repo}:` : ''
	if (refType === 'branch') {
